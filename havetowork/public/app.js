...
function App() {
  ...
  useEffect(() => {
    if (!currentUser) return;
    saveUserData(currentUser, { apiKey, balance, obligations, receivables, actions });
  }, [currentUser, apiKey, balance, obligations, receivables, actions]);
